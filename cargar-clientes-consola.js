// SCRIPT PARA CARGAR CLIENTES EN LA CONSOLA DEL NAVEGADOR
// 1. Abre marketplace.html en el navegador
...
(async function() {
  ...
  const { collection, doc, setDoc } = window.firebase.firestoreHelpers;
  ...
  const clientes = [
    ...
    {codigo: '0049', nombre: 'CMA INSUMOS SRL', nombreComercial: 'CMA INSUMOS SRL', grupo: 'ST', departamento: '', inscripcion: 'Exento Exterior', nroDocumento: '0', direccion: 'IBERÁ 1544 7C', ciudad: '', provincia: 'BA', pais: 'ar', telefono: '3884041867', email: ''},
    ...
    {codigo: '0054', nombre: 'CONNECTING PEOPLE SRL', nombreComercial: 'CONNECTING PEOPLE SRL', grupo: 'ST', departamento: '', inscripcion: 'Exento Exterior', nroDocumento: '0', direccion: 'NUÑEZ 1750 PB B', ciudad: '', provincia: 'BA', pais: 'ar', telefono: '3884041867', email: ''},
    {codigo: '0056', nombre: 'GUSTAVO DANIEL CARDACI', nombreComercial: 'GUSTAVO DANIEL CARDACI', grupo: 'ST', departamento: '', inscripcion: 'Exento Exterior', nroDocumento: '0', direccion: 'NUÑEZ 2422 5 509', ciudad: '', provincia: 'BA', pais: 'ar', telefono: '3884041867', email: ''},
  ...
  for (const cliente of clientes) {
    try {
      const clienteRef = doc(db, 'clientes', cliente.codigo);
      ...
      console.error(`❌ Error cargando ${cliente.codigo}:`, error);
    }
  }

  console.log(`\n🎉 ¡Carga completada!`);
  console.log(`✅ Total cargados: ${cargados}/${clientes.length}`);
  console.log('\n📋 Ahora abre CLIENTES desde el menú para verlos');
})();
